                                ...
                                @forelse  ($subMenu as $dt)
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static"
                                        ...
                                        <td class="align-middle product white-space-nowrap" style="min-width:200px;">
                                            <h6 class="fw-semi-bold mb-0">{{ $dt->subMenu }}</h6>
                                        </td>
                                        <td class="align-middle product white-space-nowrap" style="min-width:200px;">
                                            <h6 class="fw-semi-bold mb-0">{{ $dt->menu->menu }}</h6>
                                        ...
                                        <td class="align-middle product white-space-nowrap" style="min-width:100px;">
                                            <h6 class="fw-semi-bold mb-0">{{ $dt->icon }}</h6>
                                        </td>
                                        <td class="align-middle product white-space-nowrap" style="min-width:100px;">
                                        ...
                                        <td class="align-middle white-space-nowrap text-end pe-0">
                                            <div class="font-sans-serif btn-reveal-trigger">
                                                ...
                                                <form id="delete-data-form-{{ $dt->id }}"
                                                    action="/deleteSubMenu/{{ Crypt::encryptString($dt->id) }}"
        ...
        <div class="modal fade" id="addData" tabindex="-1" aria-labelledby="addDataLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ url('/storeSubMenu') }}">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    class="form-control form-control-sm @error('subMenu') is-invalid @enderror"
                    ...
                    <form id="edit-data-form">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">{{ ucfirst(trans($title)) }}:</label>
                                <input type="text"
                                    class="form-control form-control-sm @error('subMenuEdit') is-invalid @enderror"
                                    name="subMenuEdit" id="subMenuEdit" value="{{ old('subMenuEdit') }}">
                                @error('subMenuEdit')
                                    <div class="text text-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="message-text" class="col-form-label">Icon:</label>
                                        <input type="text"
                                            class="form-control form-control-sm @error('iconEdit') is-invalid @enderror"
                                            name="iconEdit" id="iconEdit" value="{{ old('iconEdit') }}">
                                        @error('iconEdit')
                                            <div class="text text-danger mt-2">
                                                {{ $message }}
                                            </div>
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.edit-data-btn', function() {
            ...
            $.ajax({
                url: '/SubMenu/edit/' + roleId,
                type: 'GET',
                success: function(response) {
                    if (response.success) {
                        $('#data-id').val(response.data.id);
                        // $('#idMenuEdit').val(response.data.idMenu);
        ...
        $('#edit-data-form').submit(function(e) {
            ...
            var subMenuEdit = $('#subMenuEdit').val();
            var urlEdit = $('#urlEdit').val();
            var iconEdit = $('#iconEdit').val();
            ...
            $.ajax({
                url: '/SubMenu/update/' + editId, // URL dengan ID role
