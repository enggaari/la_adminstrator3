                ...
                <div class="row flex-center min-vh-100 py-5">
                    <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3">
                        <div class="text-center mb-5">
                            <div class="avatar avatar-3xl mb-4"><img class="rounded-circle"
                                    src="../../../assets/img/team/30.png" alt=""></div>
                            <h2 class="text-800"><span class="fw-normal">Access blocked! </span></h2>
                            <p class="text-700">Please return to your page</p>
                        </div>
