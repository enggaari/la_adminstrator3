                ...
                <div class="row flex-center min-vh-100 py-5">
                    <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a
                        ...
                        {{-- <button class="btn btn-phoenix-secondary w-100 mb-3"><span
                                class="fab fa-google text-google me-2 fs--1"></span>Sign in with google</button><button
                            class="btn btn-phoenix-secondary w-100"><span
                                class="fab fa-facebook text-facebook me-2 fs--1"></span>Sign in with facebook</button> --}}
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row flex-between-center mb-7">
                                ...
                                <div class="col-auto"><a class="fs--1 fw-semi-bold" href="#!">Forgot Password?</a>
                                </div> --}}
                            </div><button type="submit" class="btn btn-primary w-100 mb-3">Sign In</button>
                        </form>
                        <div class="text-center"><a class="fs--1 fw-bold" href="{{ route('register') }}">Create an
                                account</a></div>
                    </div>
                </div>
            </div>
