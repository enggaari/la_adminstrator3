        ...
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
                            ...
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/behance.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/google-cloud.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/github.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/bitbucket.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/google-drive.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/figma.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/google-maps.png') }}" alt=""
                                            width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('assets/img/nav-icons/google-photos.png') }}"
                                            alt="" width="30">
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 px-0 ms-5" id="navbarDropdownUser" href="#"
                    ...
                    <div class="avatar avatar-l"><img class="rounded-circle"
                            src="{{ asset('assets/img/team/57.png') }}" alt=""></div>
                </a>
                    ...
                    <div class="card bg-white position-relative border-0">
                        ...
                        <div class="card-footer p-0 border-top">
                            ...
                            <div class="px-3"><a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                                    href="/logout"><span class="me-2" data-feather="log-out"></span>Sign out</a>
                            </div>
